...
@export var width : float = 300: set = set_width
@export var offset : float = 80
@export var color : Color = Color(1, 0, 1, 1): set = set_color
@export var inverted : bool = false: set = set_inverted
@export var show_hole : bool = true: set = set_show_hole
...
func refresh():
	if is_inside_tree():
		...
		$StaticBody2D/CollisionShape2D.shape.size.x = width
