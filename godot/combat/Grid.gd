...
@export var fg_color = Color(1,1,1,1): set = set_fg_color
@export var bg_color = Color(0,0,0,1): set = set_bg_color
@export var clock : bool = false: set = set_clock

@export var saturation : float = 1.0: set = set_saturation
