...
@export var shoot_bombs : bool = true :
	get:
		return shoot_bombs # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of set_bombs
@export var deadly_trails : bool = false
@export var deadly_trails_duration : float = 2.0
enum BOMB_TYPE { classic, ball, bullet, bubble, mine, ice, wave }
@export var bomb_type: BOMB_TYPE = BOMB_TYPE.classic
